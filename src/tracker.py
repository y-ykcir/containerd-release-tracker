"""Main tracker module that orchestrates the release analysis process."""
...
class ContainerdReleaseTracker:
    """Main tracker class that orchestrates the release analysis."""
    ...
    def run_analysis(self, send_notification: bool = True,
        ...
        print("🚀 Starting Containerd Release Analysis...")
        ...
        print("🔍 Analyzing PRs and issues...")
    ...
    def get_release_summary(self, include_prerelease: bool = False) -> Optional[str]:
        ...
        summary = f"""
Latest Containerd Release: {release_info.name}
