...
**原始PR标签:** kind/enhancement, size/L, area/distribution, cherry-picked/2.3.x
**原始PR内容:** Allow the last host to retry on transient network errors to incrase the likelihood of the operation succeeding and help r...
